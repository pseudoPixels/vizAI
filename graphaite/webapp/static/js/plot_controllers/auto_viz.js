$(document).ready(function(){
    	...
    	$.ajax({
            ...
            success: function (option) {
                ...
                // for (aPlotID in option['plots']){
                //     // $("#tab-row-"+aPlotID).append("<div class='col-lg-6'><div class='card'><div class='card-body'><h4 class='card-title box-title'>"+ aPlotID +"</h4>            <div id='" + aPlotID + "' style='width:100%;'></div>   </div></div></div>" );
                //     var figure = JSON.parse(option['plots'][aPlotID]);
                //     Plotly.newPlot(aPlotID, figure.data, figure.layout);
                // }
            },
